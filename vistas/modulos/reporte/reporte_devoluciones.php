...
<div class="container mt-3" style="margin-bottom:calc(30%)">
    ...
    <h2 style="width:calc(100%); text-align:center; text-transform:uppercase; margin-bottom:2rem;">Reporte de devoluciones</h2>
    ...
    <div class="container mt-3">
        <table class="table table-bordered" style="width: 100%; margin: 0 auto; background-color:#003366; color:white;">
            ...
            <tbody>
                <tr>
                    <td style="background-color:#003366; color:white; text-align:center;">Total devoluciones</td>
